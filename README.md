...
- **Current implementation**: `[0x82329f7FEF3178be989A99bb5e08Fff3E426Fa41]` (for reference only - do not hardcode)
...
For upgrade notifications contact: t.me/kdotTrades on Telegram.
    ...
    },
    {
      ...
      "inputs": [
        ...
        { "name": "maxEthCost", "type": "uint64", "internalType": "uint64" },
    ...
    },
    {
      ...
      "outputs": [
        ...
        { "name": "creatorFee", "type": "uint64", "internalType": "uint64" }
      ],
      "stateMutability": "view"
    },
    {
    ...
    { "type": "error", "name": "TooMuchEthRequired", "inputs": [] },
    ...
    { "type": "error", "name": "WithdrawTooFrequent", "inputs": [] }
